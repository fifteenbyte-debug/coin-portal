...
function refreshToken(token) {
  console.log('[refreshToken] 开始刷新, 传入的 refreshToken:', token)
  commonApi.refreshToken(token).then(res => {
    console.log('[refreshToken] 刷新返回结果:', res)
    let data = res.data;
    console.log('[refreshToken] 新的 access_token:', data.access_token)
